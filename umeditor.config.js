...
(function() {
    ...
    window.UMEDITOR_CONFIG = {
        ...
        UMEDITOR_HOME_URL: URL
            ...
            //图片上传配置区
            ,
        imageUrl: "http://123.103.86.52:11145/pand/file/upload" //图片上传提交地址
            ,
        imagePath: "http://123.103.86.52:11145/pand/file/upload" //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
            ,
        ...
        toolbar: [
            ...
            '| justifyleft justifycenter justifyright justifyjustify | formula fontsize ',
            ' image ', ' print  '
        ],
        ...
        filterRules: function() {
            return {
                span: function(node) {
                    if (node.getAttr('class') == 'mathquill-embedded-latex') {
                        return true;
                    } else {
