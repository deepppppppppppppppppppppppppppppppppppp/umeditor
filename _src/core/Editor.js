...
(function () {
    ...
    Editor.prototype = {
        ...
        /**
         * 销毁编辑器实例对象
         * 修改: 直接改成全部销毁方式，不再创建一个textarea，存放文本内容。
         * @author: zyx
         * @name destroy
        ...
        render: function (container) {
            ...
            if (container) {
                ...
                /**
                 * @author: zyx
                 * 修改：获取宽度值，包括padding值, 这里是内框间距值
                 */
                container.style.width = /%$/.test(options.initialFrameWidth) ?  '100%' : options.initialFrameWidth 
                // - getStyleValue("padding-left")- getStyleValue("padding-right")  
                +'px';
